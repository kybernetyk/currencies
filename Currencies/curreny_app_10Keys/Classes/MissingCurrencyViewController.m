...
- (IBAction) showCompositionView: (id) sender;
{
	...
	{
		UIAlertView *alert = [[UIAlertView alloc] initWithTitle: NSLocalizedString (@"No currency specified",@"") message: NSLocalizedString (@"Please enter at least one currency you would like to see in Currency",@"") delegate: nil cancelButtonTitle: @"Ok" otherButtonTitles: nil];
		[alert show];
		[alert release];
	...
	[picker setSubject: NSLocalizedString (@"Currency - Currency Suggestion",@"email subject")];
	
	// Fill out the email body text
	NSString *emailBody = [NSString stringWithFormat:@"%@ %@\n",NSLocalizedString(@"Hello Flux Forge!\n\nI'd like to see the following currencies added to Currency: ",@"email body"),[currencyList text] ];
