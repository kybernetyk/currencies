...
- (IBAction) showCompositionView: (id) sender;
{
	...
	{
		UIAlertView *alert = [[UIAlertView alloc] initWithTitle: NSLocalizedString (@"No currency specified",@"") message: NSLocalizedString (@"Please enter at least one currency you would like to see in Currency Converter",@"") delegate: nil cancelButtonTitle: @"Ok" otherButtonTitles: nil];
		[alert show];
		[alert release];
	...
	[picker setSubject: NSLocalizedString (@"Currency Converter - Currency Suggestion",@"email subject")];
	
	// Fill out the email body text
	NSString *emailBody = [NSString stringWithFormat:@"%@ %@\n",NSLocalizedString(@"Hello Flux Forge!\n\nI'd like to see the following currencies added to Currency Converter: ",@"email body"),[currencyList text] ];
